...
while true; do
    ...
    case $yn in
    [Yy]*)
        bash -c "$(wget -qO - https://raw.githubusercontent.com/IIPoliII/Install-Script-For-New-Servers/master/Script/VPN/openvpn-install.sh)"
        break
        ;;
    [Nn]*) break ;;
    *) echo "Please answer yes or no." ;;
...
while true; do
    ...
    [Yy]*)
        ...
        if [[ $torrentdelugetransmission == "1" ]]; then
			...
			update-rc.d deluge-daemon enable
...
while true; do
    ...
    1)
        ...
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 -y
    ...
    5)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 mono-complete -y
    ...
    6)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 xz-utils -y
    ...
    8)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 lib32tinfo5 -y
    ...
    12)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install mailutils postfix curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 -y
    ...
    13)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux -y
    ...
    17)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 zlib1g -y
    ...
    18)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 libcurl4-gnutls-dev:i386 libtcmalloc-minimal4:i386 -y
    ...
    19)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq libmariadb2 -y
    ...
    20)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 libcurl4-gnutls-dev:i386 -y
    ...
    21)
        sudo dpkg --add-architecture i386
        sudo apt update
        sudo apt install curl wget file bzip2 gzip unzip bsdmainutils python util-linux ca-certificates binutils bc jq tmux lib32gcc1 libstdc++6 libstdc++6:i386 lib32z1 -y
